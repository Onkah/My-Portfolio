  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon" >
          <ul>
            <li>
              <a
                href="https://www.facebook.com/drRhinestone"
            ...
            <li>
              <a
                href="https://www.instagram.com/dr_rhinestone98/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/onkabetse-mankgelo/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Onkabetse</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
